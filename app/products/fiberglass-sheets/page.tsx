...
const pageDescription =
  "Fiberglass sheets & FRP plate 2–25 mm: pultruded flat sheet cut to size for gusset plates, tank baffles, wear pads, anti-slip plate. E-glass/VE. DDP USA.";
  ...
  return (
    <>
      ...
      <PageHeader
        ...
        title="Fiberglass sheets & FRP plate, cut to size"
