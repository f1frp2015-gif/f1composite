  ...
  return <>
    ...
    <section id="frame-design" className="scroll-mt-[110px] bg-white py-12 md:py-16">
      <div className={`${wrap} grid items-center gap-8 lg:grid-cols-[1.2fr_1fr]`}>
        ...
        <div>
          ...
          <div className="mt-6 rounded-xl bg-bg2 p-6"><h3 className="text-f16 font-bold text-t1">What F1 supplies</h3><p className="mt-2 text-f14 leading-relaxed text-t2">{page.scope}</p></div>
        </div>
      </div>
    </section>
      ...
      <div className={wrap}>
        ...
        <div className="mt-8 grid gap-7 lg:grid-cols-[1fr_1.25fr]">
          <div>
            ...
            <p className="mt-4 text-f16 leading-relaxed text-t2">These example dimensions help explain the illustrated section family. They are not an F1 stocked-size list or tooling confirmation. Metric values are rounded conversions of the inch reference dimensions.</p>
    ...
    <section className="bg-bg2 py-12 md:py-16">
      <div className={wrap}>
        ...
        <div className="mt-7 grid gap-5 md:grid-cols-2 lg:grid-cols-4">{page.components.map((item, index) => <article key={item.title} className="rounded-xl border border-border-default bg-white p-6"><p className="text-f14 font-bold text-teal-text">0{index + 1}</p><h3 className="mt-4 text-f20 font-bold text-t1">{item.title}</h3><p className="mt-3 text-f14 leading-relaxed text-t2">{item.body}</p></article>)}</div>
    ...
    <section id="assembly" className="scroll-mt-[150px] bg-white py-12 md:py-16">
      <div className={wrap}>
        ...
        <div className="mt-7 grid gap-6 md:grid-cols-2">{page.assembly.map((item) => <article key={item.title} className="rounded-xl border border-border-default p-6"><h3 className="text-f20 font-bold text-t1">{item.title}</h3><p className="mt-3 text-f16 leading-relaxed text-t2">{item.body}</p></article>)}</div>
      </div>
    </section>
    ...
    <section id="request-quote" className="scroll-mt-[110px] bg-white py-12 md:py-16">
      <div className={`${wrap} grid gap-8 lg:grid-cols-2`}>
        ...
        <div className="rounded-xl border border-border-default bg-bg2 p-7"><h3 className="text-f20 font-bold text-t1">Include with your inquiry</h3><ul className="mt-4 list-disc space-y-3 pl-5 text-f16 text-t2">{page.checklist.map((item) => <li key={item}>{item}</li>)}</ul></div>
      </div>
    </section>
