...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "No. These are industrial composite product-line names from F1 Composite, a pultruded FRP (fiberglass) profiles manufacturer in Chongqing, China. They have no connection to Formula 1, the FIA, or motorsport. The names denote FRP product families used in construction, infrastructure, energy, marine, and industrial applications.",
  },
  {
