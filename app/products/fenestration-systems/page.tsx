...
export default function FenestrationSystemsPage() {
  return (
    <>
      ...
      />
      <PageHeader
        tag="Fenestration Systems"
        title="Pultruded FRP Window & Door Systems"
        description="High-performance fenestration systems that deliver thermal insulation, structural integrity, and dimensional stability that aluminum and PVC cannot match. 60/70/80/90-series for every climate and performance tier."
        breadcrumbs={[
          { label: "Home", href: "/" },
          ...
          <div className="grid gap-[21px] md:grid-cols-2">
            <div className="overflow-hidden rounded-[8px] border border-border-default bg-bg2 p-[13px]">
              <Image
                ...
                priority
              />
              <p className="mt-[8px] text-center text-f13 font-medium text-t2">80-Series Tilt & Turn</p>
            </div>
            <div className="overflow-hidden rounded-[8px] border border-border-default bg-bg2 p-[13px]">
              <Image
                ...
                priority
              />
              <p className="mt-[8px] text-center text-f13 font-medium text-t2">140-Series Sliding</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-[1280px] px-[34px]">
          <div className="max-w-[780px]">
            <p className="text-f19 leading-golden text-t2">
              FRP (fiber-reinforced polymer) fenestration systems represent a generational
              advancement in window and door frame technology. At F1 Composite, we engineer
            ...
            <p className="mt-[21px] text-f15 leading-golden text-t2">
              We offer four system series, each designed for a specific performance tier and
              market segment. From the compact 60-series for residential renovation to the
              flagship 90-series for passive house and arctic climate applications, our
              fenestration profiles provide architects, fabricators, and building owners with
              a frame material that does not compromise thermal performance for structural
              strength, or durability for aesthetics. Every profile is manufactured using our
              continuous pultrusion process, ensuring dimensional consistency across production
              runs that can span tens of thousands of linear meters.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-white py-[55px]">
        <div className="mx-auto max-w-[1280px] px-[34px]">
          ...
          <div className="flex flex-col gap-[13px] sm:flex-row sm:gap-[34px]">
            ...
            <LinkArrow href="/technology/quality-testing">
              Quality and testing
            </LinkArrow>
