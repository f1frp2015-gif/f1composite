      ...
      <section className="bg-white py-[55px]">
        <div className="mx-auto max-w-[1280px] px-[34px]">
          ...
          <div className="mt-[21px] grid gap-[21px] md:grid-cols-3">
            <div className="rounded-[8px] border border-border-default bg-white p-[21px]">
              ...
              <p className="mt-[8px] text-f13 leading-golden text-t2">
                Top and mid rail in{" "}
                <Link href="/products/standard-profiles/tube" className="font-semibold text-teal-text hover:underline">
                  Ø50 round tube
                </Link>{" "}
                (industrial standard, comfortable grip) or{" "}
                <Link href="/products/standard-profiles/square-tube" className="font-semibold text-teal-text hover:underline">
                  50×50 square tube
                </Link>{" "}
          ...
          <p className="mt-[21px] max-w-[860px] text-f15 leading-golden text-t2">
            ...
            and{" "}
            <Link href="/products/gratings" className="font-semibold text-teal-text hover:underline">
              grating walkways
            </Link>
            .
          </p>
        ...
        groups={[
          {
            ...
            links: [
              { href: "/products/standard-profiles/tube", label: "Fiberglass round tubes (rails)" },
              { href: "/products/standard-profiles/square-tube", label: "Square tubes (posts)" },
              { href: "/products/standard-profiles/flat-bar", label: "Flat bar (kickplate)" },
              { href: "/products/stair-tread-covers", label: "Stair tread covers & treads" },
            ],
          },
          {
            title: "Specify & buy",
