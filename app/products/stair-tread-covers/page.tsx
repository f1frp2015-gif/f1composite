          ...
          <div className="mt-[21px] grid gap-[21px] md:grid-cols-2">
            ...
            <div className="rounded-[8px] border border-border-default bg-white p-[24px]">
              ...
              <p className="mt-[13px] text-f15 leading-golden text-t2">
                ...
                <Link href="/products/handrail-systems" className="font-semibold text-teal-text hover:underline">
        ...
        groups={[
          {
            ...
            links: [
              ...
              { href: "/products/gratings", label: "Fiberglass gratings & deck panels" },
              { href: "/products/standard-profiles/channel", label: "Channels for stringers" },
