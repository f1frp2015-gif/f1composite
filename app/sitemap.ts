...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  return [
    ...
    { url: `${BASE}/tools/thermal-expansion-calculator`, changeFrequency: "monthly", priority: 0.75 },
    { url: `${BASE}/tools/handrail-load-calculator`, changeFrequency: "monthly", priority: 0.75 },
    { url: `${BASE}/tools/access-geometry-checker`, changeFrequency: "monthly", priority: 0.75 },
    { url: `${BASE}/tools/gfrp-rebar-calculator`, changeFrequency: "monthly", priority: 0.75 },
    ...
    { url: `${BASE}/products/fiberglass-structural-shapes/frp-square-tube`, lastModified: "2026-09-14", changeFrequency: "monthly", priority: 0.7 },
    ...
    { url: `${BASE}/products/frp-sound-barrier-wall`, changeFrequency: "monthly", priority: 0.82 },
    { url: `${BASE}/technology/china-alternative-to-tencom-creative-pultrusions-windows`, changeFrequency: "monthly", priority: 0.85 },
    { url: `${BASE}/products/frp-gratings`, lastModified: "2026-09-20", changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE}/products/frp-deck-panels`, changeFrequency: "monthly", priority: 0.82 },
    { url: `${BASE}/products/molded-frp-grating`, lastModified: "2026-09-20", changeFrequency: "monthly", priority: 0.82 },
    ...
    { url: `${BASE}/products/fiberglass-sheets`, lastModified: "2026-09-14", changeFrequency: "monthly", priority: 0.8 },
    ...
    { url: `${BASE}/technology/fiberglass-rebar-vs-steel`, lastModified: "2026-09-21", changeFrequency: "monthly", priority: 0.85 },
    ...
    { url: `${BASE}/case-studies`, changeFrequency: "weekly", priority: 0.8 },
    {
      ...
      priority: 0.9,
      images: [
        `${BASE}/images/case-studies/beam-bridge/pedestrian-cycle-beam-bridge-load-path.svg`,
        `${BASE}/images/case-studies/beam-bridge/pedestrian-cycle-bridge-section.svg`,
        `${BASE}/images/case-studies/beam-bridge/footbridge-vibration-serviceability.svg`,
        `${BASE}/images/case-studies/beam-bridge/moggill-road-cycle-bridge-case-study.svg`,
        `${BASE}/images/case-studies/beam-bridge/coronation-drive-frp-cycleway-case-study.svg`,
        `${BASE}/images/case-studies/beam-bridge/sao-silvestre-gfrp-footbridge-case-study.svg`,
      ],
    },
