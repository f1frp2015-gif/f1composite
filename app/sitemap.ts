...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  return [
    ...
    { url: `${BASE}/products/standard-profiles`, changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE}/products/standard-profiles/i-beam`, changeFrequency: "monthly", priority: 0.7 },
    { url: `${BASE}/products/standard-profiles/angle`, changeFrequency: "monthly", priority: 0.7 },
    { url: `${BASE}/products/standard-profiles/channel`, changeFrequency: "monthly", priority: 0.7 },
    { url: `${BASE}/products/standard-profiles/square-tube`, changeFrequency: "monthly", priority: 0.7 },
    { url: `${BASE}/products/standard-profiles/tube`, changeFrequency: "monthly", priority: 0.7 },
    { url: `${BASE}/products/standard-profiles/flat-bar`, changeFrequency: "monthly", priority: 0.7 },
    { url: `${BASE}/products/standard-profiles/rod`, changeFrequency: "monthly", priority: 0.7 },
    { url: `${BASE}/products/custom-pultrusions`, changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE}/products/solar-mounting-systems`, changeFrequency: "monthly", priority: 0.85 },
    { url: `${BASE}/products/fenestration-systems`, changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE}/products/facade-sunshade-panels`, changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE}/products/window-reinforcement-profiles`, changeFrequency: "monthly", priority: 0.75 },
    { url: `${BASE}/technology/china-alternative-to-tencom-creative-pultrusions-windows`, changeFrequency: "monthly", priority: 0.85 },
    { url: `${BASE}/products/gratings`, changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE}/products/stair-tread-covers`, changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE}/products/handrail-systems`, changeFrequency: "monthly", priority: 0.8 },
    ...
    { url: `${BASE}/resources/ddp-tariff-hs-code-guide`, changeFrequency: "monthly", priority: 0.78 },
