...
- Standards are specification references for the project. Never state that F1 holds a certificate or operator approval; certificates are provided on request with the holder, number and scope.
