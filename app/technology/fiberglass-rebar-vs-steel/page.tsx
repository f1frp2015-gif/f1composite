  ...
  return (
    <div>
      <div className="flex items-end justify-between gap-[13px]">
        <div>
          <p className="text-f14 font-bold text-t1">{label}</p>
          {note ? <p className="mt-[2px] text-f12 text-t3">{note}</p> : null}
        </div>
        <p className="shrink-0 text-f16 font-extrabold tabular-nums text-t1">
          {display}
        </p>
      </div>
  ...
  return (
    <>
      ...
      <section className="bg-white py-[72px] md:py-[89px]">
        <div className="site-container grid gap-[42px] lg:grid-cols-[1.08fr_0.92fr] lg:items-center">
          <div>
            <SectionTag>The engineering answer</SectionTag>
            <h2 className="mt-[21px] max-w-[760px] text-[clamp(27px,3.4vw,43px)] font-extrabold leading-[1.1] tracking-[-0.02em] text-t1">
        ...
        <div className="site-container">
          ...
          <div className="mt-[21px] grid gap-[21px] lg:grid-cols-2">
            <div>
              ...
              <p className="mt-[13px] max-w-[760px] text-f16 leading-golden text-t2">
          ...
          <div className="mt-[21px] grid gap-[21px] lg:grid-cols-[1.1fr_0.9fr]">
            <figure className="rounded-card border border-border-default bg-deep p-[24px] text-white md:p-[29px]">
              ...
              <figcaption className="mt-[21px] text-f12 leading-relaxed text-white/45">
              ...
              <tbody>
                {comparisonRows.map((row) => (
                  <tr key={row.topic} className="border-t border-border-default align-top">
                    <th className="w-[16%] px-[18px] py-[16px] text-f14 font-bold text-t1">{row.topic}</th>
                    <td className="w-[29%] bg-teal/5 px-[18px] py-[16px] text-f14 leading-golden text-t2">{row.gfrp}</td>
                    <td className="w-[29%] px-[18px] py-[16px] text-f14 leading-golden text-t2">{row.steel}</td>
        ...
        <div className="site-container">
          ...
          <div className="mt-[34px] grid gap-[21px] lg:grid-cols-2">
            <article className="rounded-card border border-rose-200 bg-rose-50 p-[24px] md:p-[29px]">
              ...
              <p className="mt-[21px] text-f14 leading-golden text-t2">
