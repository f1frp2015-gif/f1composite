...
export default function QualityTestingPage() {
  return <>
    ...
    <section className="bg-bg2 py-[40px]"><div className="site-container">
      ...
      <div className="mt-[34px] grid gap-[20px] md:grid-cols-2">{checks.map((check) => <article key={check.title} className="rounded-[8px] border border-border-default bg-white p-[24px]"><h2 className="text-f18 font-bold text-t1">{check.title}</h2><p className="mt-[10px] text-f16 leading-relaxed text-t2">{check.text}</p></article>)}</div>
