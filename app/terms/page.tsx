      ...
      <section className="bg-white py-[89px]">
        <div className="mx-auto max-w-[780px] px-[34px]">
          <div className="prose-custom space-y-[34px] text-f16 leading-golden text-t2">
            <div>
              <h2 className="mb-[13px] text-f18 font-bold text-t1">1. Acceptance of Terms</h2>
            ...
            <div>
              <h2 className="mb-[13px] text-f18 font-bold text-t1">2. Product Information</h2>
            ...
            <div>
              <h2 className="mb-[13px] text-f18 font-bold text-t1">3. Intellectual Property</h2>
            ...
            <div>
              <h2 className="mb-[13px] text-f18 font-bold text-t1">4. Quotations and Orders</h2>
            ...
            <div>
              <h2 className="mb-[13px] text-f18 font-bold text-t1">5. Limitation of Liability</h2>
            ...
            <div>
              <h2 className="mb-[13px] text-f18 font-bold text-t1">6. Governing Law</h2>
            ...
            <div>
              <h2 className="mb-[13px] text-f18 font-bold text-t1">7. Contact</h2>
