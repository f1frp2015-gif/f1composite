      ...
      <section className="bg-white py-[55px]">
        <div className="mx-auto max-w-[900px] px-[21px]">
          ...
          <div className="mt-[21px] flex flex-wrap gap-[21px]">
            <Link href="/products/frp-window-frames" className="text-f14 font-semibold text-teal-text hover:underline">
              → FRP windows and doors (9 systems)
            </Link>
            <Link href="/technology/frp-u-value-calculator" className="text-f14 font-semibold text-teal-text hover:underline">
            ...
            <Link href="/downloads/phi-certificate-gfrp-90-series-2491wi03.pdf" className="text-f14 font-semibold text-teal-text hover:underline" target="_blank" rel="noopener noreferrer">
