  ...
  const payload = {
    ...
    productFamilies: [
      ...
      },
      {
        ...
        series: ["50", "55", "60", "65", "70", "80", "90 casement", "90 sliding", "140 compression-seal sliding"],
        profileCodeScope: { "50": "GF07", "55": "GF08", "90 sliding": "CP001–CP005; component names and drawings require confirmation", "140 compression-seal sliding": "CP006–CP011" },
        supplyRoutes: [
          { url: `${SITE}/products/window-door-profiles`, scope: "System profiles for local fabrication; confirm sections, BOM, finish, machining and accessories." },
          { url: `${SITE}/products/fiberglass-windows-doors`, scope: "Finished units for local installation; confirm window schedule, glazing, hardware, packing and installation interfaces." },
        ],
        evidenceBoundary: "Series depth does not establish a Uw, load capacity or certification. Historical Intertek 240821010SHF-002 covers its Lift-Sliding Door specimen and is not automatic evidence for the current 140 Series Compression-Seal Sliding Door.",
