...
const downloads: {
  ...
  { title: "ISO 9001:2015 Certificate", format: "PDF", size: "0.5 MB", category: "certification", file_url: null, description: "Available on request, with the certificate holder, number and scope." },
  { title: "CE Declaration of Performance", format: "PDF", size: "1 MB", category: "certification", file_url: null, description: "Product-specific performance and conformity documents on request; confirm the intended use and assessment route." },
