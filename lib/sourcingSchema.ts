...
export const sourcingRecommendationSchema = z.object({
  ...
  profileFamily: z.object({
    name: z
      .string()
      .describe(
        "Primary recommended FRP product family — one of: Standard structural profiles, Custom pultrusions, FRP fenestration systems, FRP grating, Structural FRP deck panels, Mixed (multi-family).",
      ),
      ...
      .array(
        z.object({
          ...
          path: z
            .string()
            .describe(
              "Internal F1 Composite URL path that documents this product, starting with /. Pick from /products/fiberglass-structural-shapes/{frp-i-beam,frp-channel,frp-angle,frp-square-tube,frp-tube,frp-flat-bar,frp-rod}, /products/custom-pultruded-profiles, /products/frp-window-frames, /products/frp-facade-panels, /products/frp-gratings (open pultruded grating), /products/molded-frp-grating, /products/frp-deck-panels, /pultruded-frp-profiles. Never invent paths.",
            ),
        }),
      )
      .min(1)
