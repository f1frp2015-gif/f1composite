  ...
  return (
    <section id="e40-test-reports" className="scroll-mt-[100px] bg-bg2 py-[55px]" aria-labelledby="e40-evidence-heading">
      <div className="site-container">
        ...
        <div className="mt-[21px] max-w-[1040px] space-y-[13px] text-f16 leading-golden text-t2">
        ...
        <nav aria-label="E40 related resources" className="mt-[21px] flex flex-wrap gap-x-[24px] gap-y-[12px] text-f14 font-semibold text-teal-text">
