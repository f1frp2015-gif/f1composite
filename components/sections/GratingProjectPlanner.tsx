...
export default function GratingProjectPlanner({ family }: { family?: 'molded' | 'pultruded' }) {
  ...
  return <section id="grating-planner" className="scroll-mt-24 bg-bg2 py-10 pb-28 lg:pb-12">
    <div className="site-container space-y-6"><span id="grating-configurations" className="block scroll-mt-24" /><span id="grating-quote" className="block scroll-mt-24" /><span id="grating-help" className="block scroll-mt-24" /><span id="grating-budget" className="block scroll-mt-24" /><span id="grating-review" className="block scroll-mt-24" />
