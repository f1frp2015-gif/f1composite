...
const items = [
  ...
  },
  {
    ...
    answer:
      "No. The \"F1\" in F1 Composite stands for \"Fiber One\" (fiberglass): it is an industrial pultruded fiberglass (FRP / GRP) profiles manufacturer based in Chongqing, China — it has no connection to Formula 1, the FIA, or motorsport. The name also anchors its four industrial product lines: F1-STRUX (pultruded structural profiles), F1-GRID (gratings & deck panels), F1-THERM (fenestration / FRP window profiles), and F1-FORM (custom pultrusions). All products are made to EN 13706 and ASTM D3917 for construction, infrastructure, energy, marine, and industrial use.",
  },
  {
