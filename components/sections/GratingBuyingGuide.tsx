  ...
  return <>
    <section id="grating-engineering" className="scroll-mt-[100px] bg-bg2 py-[44px] md:py-[60px]">
      <div className="site-container">
        ...
        <div className="mt-[24px] grid gap-[18px] lg:grid-cols-3">
          ...
          <article className="rounded-card border border-border-default bg-white p-[24px]">
            <h3 className="text-f18 font-bold">Fixing clips & CAD</h3>
          ...
          <article className="rounded-card border border-teal-border bg-teal-bg p-[24px]">
            <h3 className="text-f18 font-bold">Project load & test data</h3>
    ...
    <section id="grating-supply" className="scroll-mt-[100px] bg-white py-[44px] md:py-[60px]">
      <div className="site-container">
        ...
        <div className="mt-[28px] flex flex-col gap-[18px] rounded-card bg-deep p-[24px] text-white md:flex-row md:items-center md:justify-between">
