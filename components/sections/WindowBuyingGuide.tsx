...
export function WindowComponentMap() {
  return <div className="grid items-center gap-8 lg:grid-cols-[1.1fr_1fr]">
    <figure className="rounded-card border border-border-default bg-bg2 p-5">
...
export function WindowBuyerPaths({ mode }: { mode?: WindowSupplyMode }) {
  ...
  return <div className="grid items-start gap-4 md:grid-cols-2">
    {paths.map((buyer) => <details key={buyer.id} className="group rounded-card border border-border-default bg-white p-5">
      ...
      <p className="mt-5 rounded-card bg-bg2 p-3 text-xs font-semibold leading-loose text-teal-text">{buyer.steps}</p>
